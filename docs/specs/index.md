...
| 0004 | Application Submission and CV Upload | specified | api/application, service/application, db/application, shared/storage, ui/portal, ui/staff | Application, CvAttachment | Candidates submit a CV-backed Application to a published Requisition; Staff and the Candidate can each see a minimal list of what was submitted. |
